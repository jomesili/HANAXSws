var select_all_sales_orders_query = 
	...
	"round(avg(CAST(COLLABORATE as REAL)), 0) as Collabvalue , CASE CONTACT_TYPE WHEN 'OTHER' THEN 'OTHER' "+
...
function getSalesOrders(){  
          ...
          try{  
                    ...
                    while (resultSet.next()) { 
                    	...
                    	salesOrder.friendValue = resultSet.getString(2); 
                    	salesOrder.BusinessValue = resultSet.getString(3);
                    	salesOrder.CollabValue = resultSet.getString(4);
                    	salesOrder.grouptype = resultSet.getString(5);
