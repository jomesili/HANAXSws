...
"round((((select count(*) from  \"SYSTEM\".\"BMBFRIENDS\" where COLLABORATE < '2')/(select count(*) from  \"SYSTEM\".\"BMBFRIENDS\"))*100),0) as mypercent, "+
"( 100 -(round((((select count(*) from \"SYSTEM\".\"BMBFRIENDS\" where COLLABORATE < '2')/(select count(*) from \"SYSTEM\".\"BMBFRIENDS\"))*100),0))) as Others "+
